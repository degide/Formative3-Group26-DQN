...
EXPERIMENTS = [
    # Experiment 1: Huge Replay Buffer
    {
        "name":                    "exp1_huge_buffer",
        "policy":                  "CnnPolicy",
        "learning_rate":           1e-4,
        "gamma":                   0.99,
        "batch_size":              32,
    ...
    # Experiment 2: Slow Target Network Update (Stability Focus)
    {
        "name":                    "exp2_slow_target",
        "policy":                  "CnnPolicy",
        "learning_rate":           1e-4,
        "gamma":                   0.99,
        "batch_size":              32,
    ...
    # Experiment 3: High Training Frequency
    {
        "name":                    "exp3_fast_train",
        "policy":                  "CnnPolicy",
        "learning_rate":           1e-4,
        "gamma":                   0.99,
        "batch_size":              32,
    ...
    # Experiment 4: Delayed Learning Start (Warm-up phase)
    {
        "name":                    "exp4_delayed_start",
        "policy":                  "CnnPolicy",
        "learning_rate":           1e-4,
        "gamma":                   0.99,
        "batch_size":              32,
    ...
    # Experiment 5: Extreme Gamma (Long-term Reward Focus)
    {
        "name":                    "exp5_high_gamma",
        "policy":                  "CnnPolicy",
        "learning_rate":           1e-4,
        "gamma":                   0.999,
        "batch_size":              32,
    ...
    # Experiment 6: Tiny Batch Size (Noisy Updates)
    {
        "name":                    "exp6_tiny_batch",
        "policy":                  "CnnPolicy",
        "learning_rate":           1e-4,
        "gamma":                   0.99,
        "batch_size":              16,
    ...
    # Experiment 7: Aggressive Epsilon Decay
    {
        "name":                    "exp7_instant_decay",
        "policy":                  "CnnPolicy",
        "learning_rate":           1e-4,
        "gamma":                   0.99,
        "batch_size":              32,
    ...
    # Experiment 8: Intermediate Learning Rate
    {
        "name":                    "exp8_mid_lr",
        "policy":                  "CnnPolicy",
    ...
    # Experiment 9: High Constant Exploration (Persistent Randomness)
    {
        "name":                    "exp9_const_explore",
        "policy":                  "CnnPolicy",
        "learning_rate":           1e-4,
        "gamma":                   0.99,
        "batch_size":              32,
    ...
    # Experiment 10: Optimized CNN (Larger Batch + Standard LR)
    {
        "name":                    "exp10_cnn_optimized",
        "policy":                  "CnnPolicy",
        "learning_rate":           1e-4,
        "gamma":                   0.99,
        "batch_size":              64,
